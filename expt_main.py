...
def main():
    ...
    parser.add_argument('--momentum', default=0.9, type=float, help='momentum for optimizer')  # Fixed: should be 0.9 per assignment
    ...
    # FIXED INDENTATION: This should be at the same level as other code
